...
export function Header() {
  ...
  const getRoleBadgeColor = (role: string) => {
    switch (role) {
      case 'admin': return 'bg-tactical-gold text-tactical-dark';
      case 'manager': return 'bg-tactical-secondary text-white';
      case 'cashier': return 'bg-tactical-accent text-white';
